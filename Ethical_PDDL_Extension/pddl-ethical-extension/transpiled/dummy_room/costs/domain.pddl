(define (domain waypoints-d-eth_GEN)
...
(:action final-mode-check-op-true-privacybreachment-diningroom
:parameters ()
:precondition (and
(final-mode )
(privacybreachment diningroom )
(not (final-mode-check-privacybreachment-diningroom ))
) 
...
(:action final-mode-check-op-false-privacybreachment-diningroom
:parameters ()
:precondition (and
(final-mode )
(not (privacybreachment diningroom ))
(not (final-mode-check-privacybreachment-diningroom ))
) 

:effect (final-mode-check-privacybreachment-diningroom )
