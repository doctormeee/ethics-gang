(define (problem waypoints-p)
  ...
  (:objects
    ...
    wp_BathroomLivingRoomInBathroom wp_BathroomLivingRoomInLvingRoom wp_KitchenLivingRoomInKitchen wp_KitchenLivingRoomInLivingRoom wp_KitchenBalconyInKitchen wp_KitchenBalconyInBalcony wp_BedroomBalconyInBedroom wp_BedroomBalconyInBalcony - waypoint ; corresponds to the "doors"
  ...
  (door_connected Bathroom_to_LivingRoom Bathroom LivingRoom wp_BathroomLivingRoomInBathroom wp_BathroomLivingRoominLvingRoom)
  ...
  (waypoint_at wp_BathroomLivingRoominLvingRoom LivingRoom)
